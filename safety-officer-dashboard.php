...
$profile_picture = !empty($user['profile_picture_path']) ? $user['profile_picture_path'] : 'assets/img/users/avatar.png';
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["profile_picture"])) {
    ...
    if (move_uploaded_file($_FILES["profile_picture"]["tmp_name"], $target_file)) {
        ...
        $stmt = $pdo->prepare("UPDATE users SET profile_picture_path = :profile_picture_path WHERE email = :email");
        $stmt->execute(['profile_picture_path' => $target_file, 'email' => $email]);
